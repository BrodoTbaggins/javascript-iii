...
let ordersTotal = orders.map(num => num.price * (num.tax + 1));
...
let bobsTotal = purchases.reduce((accumalator, currentValue, index) =>{
    return currentValue.owner === 'Bob' ? accumalator + currentValue.price : accumalator
}, 0 )